import {
  ContractingCoverImage,
  FabricShadeEngineerCoverImage,
  LandscapingCoverImage,
  ManufacturingCoverImage,
  TradingCoverImage,
} from "@/components/constants/services-image";
...
export const servicesData = [
  ...
  {
    title: "Manufacturing",
    paragraph1: "Details unavailable.",
    paragraph2: "Details unavailable.",
